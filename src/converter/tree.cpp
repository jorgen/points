...
//}
//
//static void sub_tree_split_points_to_children(const tree_global_state_t &state, points_collection_t &&points, int lod, const morton::morton64_t &node_min, points_collection_t (&children)[8])
//{
...
//}
//
//static void sub_tree_insert_points(const tree_global_state_t &state, tree_t &tree, const morton::morton64_t &min, int current_level, int skip, points_collection_t &&points)
//{
