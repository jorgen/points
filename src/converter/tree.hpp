...
tree_id_t tree_initialize(const tree_config_t &tree_config, tree_registry_t &tree_cache, storage_handler_t &cache, const storage_header_t &header, attributes_id_t attributes_id,
                          std::vector<storage_location_t> &&locations);
