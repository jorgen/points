                                   ...
                                   bool debug)
{
  ...
  if (debug)
  {
    fmt::print(stderr, "[transition-debug] draw: emitted={} skipped_frustum={} skipped_unrendered={} awaiting={} crossfading={} fading={} steady={} frustum_completed={}\n",
               dbg_emitted, dbg_skipped_frustum, dbg_skipped_unrendered, dbg_awaiting, dbg_crossfading, dbg_fading, dbg_steady, dbg_frustum_completed);
  }
