...
template <typename S_M, typename D_M>
static void quantize_morton_two(const morton::morton192_t &morton_min, const morton::morton192_t &morton_max, dew_type_t source_type, const std::vector<uint32_t> &indecies_to_quantize, const dew_converter_buffer_t &source,
                                dew_type_t destination_type, dew_converter_buffer_t &destination)
{
  (void)source_type;
...
static void quantize_morton_one(const morton::morton192_t &morton_min, const morton::morton192_t &morton_max, dew_type_t source_type, const std::vector<uint32_t> &indecies_to_quantize, const dew_converter_buffer_t &source,
                                dew_type_t destination_type, dew_converter_buffer_t &destination)
{
...
#ifndef NDEBUG
static const void *buffer_end(const dew_converter_buffer_t &buffer)
{
  return ((const uint8_t *)buffer.data) + buffer.size;
}
static bool buffer_is_subset(const dew_converter_buffer_t &super, const dew_converter_buffer_t &sub)
{
...
void convert_points_impl(input_data_id_t input_id, const std::vector<std::pair<input_data_id_t, uint32_t>> &indecies, const point_format_t &source_format, const dew_converter_buffer_t &source, const point_format_t &destination_format,
                         dew_converter_buffer_t &destination)
{
  (void)source_format;
...
void convert_points_three(input_data_id_t input_id, const std::vector<std::pair<input_data_id_t, uint32_t>> &indecies, const point_format_t &source_format, const dew_converter_buffer_t &source,
                          const point_format_t &destination_format, dew_converter_buffer_t &destination)
{
...
void convert_points_two(input_data_id_t input_id, const std::vector<std::pair<input_data_id_t, uint32_t>> &indecies, const point_format_t &source_format, const dew_converter_buffer_t &source, const point_format_t &destination_format,
                        dew_converter_buffer_t &destination)
{
...
template <size_t S_S>
void convert_points_one(input_data_id_t input_id, const std::vector<std::pair<input_data_id_t, uint32_t>> &indecies, const point_format_t &source_format, const dew_converter_buffer_t &source, const point_format_t &destination_format,
                        dew_converter_buffer_t &destination)
{
...
static void copy_attribute_for_input(input_data_id_t input_id, const std::vector<std::pair<input_data_id_t, uint32_t>> &indecies, const point_format_t &source_format, const dew_converter_buffer_t &source_buffer,
                                     const point_format_t &target_format, dew_converter_buffer_t &target_buffer)
{
                            ...
                            std::vector<morton_to_lod_t<T, N>> &morton_to_lod)
{
  ...
  const dew_converter_buffer_t source_buffer = morton_buffer_for_subset(subset_data.data, subset_data.header.point_format.type, offset, point_count);
