...
namespace points
{
  namespace render
  {
    ...
    POINTS_RENDER_EXPORT void camera_look_at(struct camera *camera, const double eye[3], const double center[3], const double up[3]);
    POINTS_RENDER_EXPORT void camera_look_at_aabb(struct camera *camera, struct aabb *aabb, const double direction[3], const double up[3]);
    ...
    POINTS_RENDER_EXPORT void camera_perspective_properties(struct camera* camera, double* fov, double* aspect, double* near, double* far);
