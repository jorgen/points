...
struct dew_axis_gizmo_data_source_t : public dew::render::data_source_cpp_t
{
  dew_axis_gizmo_data_source_t(dew::render::callback_manager_t &callbacks, const glm::dvec3 &center, double axis_length);
